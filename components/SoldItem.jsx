...
const SoldItem = ({ area, price, title, backgroundImg, lStatus }) => {
	return (
		<div className="relative flex items-center justify-center h-auto w-full shadow-xl hover:shadow-none shadow-gray-400 bg-white border-8 border-white group hover:bg-neutral-700 transition-all duration-500">
			<Image
			...
			<div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
				<h3 className="min-w-[200px] text-2xl lg:text-xl font-thin text-white tracking-wider text-center">
					{title}
				</h3>
